                                        ...
                                        <thead class="bg-gray-50">
                                            <tr>
                                                ...
                                                <th scope="col"
                                                    ...
                                                    Title</th>
                                                <th scope="col"
                                                    class="sticky top-0 z-10 text-left hidden border-b border-gray-300 bg-gray-50 bg-opacity-75 px-3 py-3.5 text-sm font-semibold text-gray-900 backdrop-blur backdrop-filter sm:table-cell">
                                                    Content</th>
                                                <th scope="col"
                                        ...
                                        <tbody class="bg-white">
                                            @foreach ($todos as $todo)
                                                <tr>
                                                    ...
                                                    <td
                                                        class="border-b border-gray-200 px-3 py-4 text-sm {{ $todo['completed_at'] ? 'text-green-600' : 'text-grey-900' }} hidden sm:table-cell">
                                                        {{ $todo['content'] }}
                                                    </td>
                                                    <td
                                                    ...
                                                    <td
                                                        ...
                                                        <div id="buttons" class="flex justify-evenly">
                                                            <form action="/todo/favorite/{{ $todo['id'] }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PATCH')
                                                                <button class="  ml-4 mr-2  ">
                                                                    ...
                                                                    @else
                                                                        <div class="notFav block w-7 h-7"><svg
                                                                                ...
                                                                                fill="rgba(0, 0, 0, 0.5);"
                                                                                fill-opacity="0.5" viewBox="0 0 24 24"
                                                                                stroke-width="1.5" stroke="white">
                                                                                <path stroke-linecap="round"
                                                                                    stroke-linejoin="round"
                                                                                    d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
